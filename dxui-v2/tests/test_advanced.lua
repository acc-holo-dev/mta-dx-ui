--[[
    ...
    Проверяет advanced widgets: checkbox, radiobutton, slider, progressbar,
    scrollpanel (scroll + clip), edit (ввод/клавиши), popup (dismiss),
...
ui:renderFrame()
ui:onMouseDown(5, 12, "left")  -- внутри box
...
ui:renderFrame()
-- click-to-jump в середину
ui:onMouseDown(150, 308, "left") -- world 100+50 = середина
...
-- wheel (нужен свежий кадр: layout + interactive list)
ui:renderFrame()
...
ui:renderFrame()
ui:onMouseDown(5, 210, "left") -- фокус
...
ui:onMouseUp(5, 210, "left") -- завершаем клик-жест (drag-select захватывает до mouseup)

-- ---------------------------------------------------------------------
-- Popup: dismiss по клику вне
-- ---------------------------------------------------------------------
...
ui:renderFrame()
ui:onMouseDown(500, 500, "left") -- клик вне popup
...
-- клик вне окна (по overlay) блокируется: фокус не меняется
...
ui:renderFrame() -- свежий interactive list (overlay2 попал в hit-test)
-- верхний modal — modal2; клик вне окна (по overlay) закрывает его
ui:onMouseDown(700, 500, "left")
ui:onMouseUp(700, 500, "left") -- dismiss срабатывает на click (down+up)
