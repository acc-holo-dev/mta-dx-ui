--[[
    ...
    Проверяет layout: absolute, relative, center, anchor (9 точек), margin,
    padding, вложенность.
]]
...
-- ---------------------------------------------------------------------
-- Relative (доля 0..1 от размера родителя = экрана для root-узла)
-- ---------------------------------------------------------------------
...
-- ---------------------------------------------------------------------
-- Вложенность (world = сумма локальных)
-- ---------------------------------------------------------------------
