--[[
    ...
    ProgressBar: индикатор прогресса. track (фон) + fill (заполнение).
    Всё рисуется в render; интерактивных частей нет (enabled=false).
]]
...
--- Билдер: ui:progressbar({ value=, min=, max=, ... }).
