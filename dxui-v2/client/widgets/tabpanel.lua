--[[
    ...
    TabPanel: вкладки. addTab(title, children) возвращает page (PANEL).
    onChange(idx). Кнопки вкладок — панели в bar; страницы — панели ниже bar.
]]
...
function TabPanel:_layoutTabs()
    ...
    for i = 1, #self._tabs do
        ...
        -- ширина вкладки по text engine (§43): точные метрики в MTA
