--[[
    ...
    Panel: rectangular surface (background). Base container widget.

    Stage 9: radius — rounded corners (SDF shader, cache shared per
    process, not per-node resource); outlineWidth/outlineColor — border
    made of 4 edges (T-layout, composed from rect).
]]
...
--- Builder: ui:panel({ x=, y=, width=, height=, color=, radius=,
